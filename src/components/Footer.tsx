...
export default function Footer() {
  return (
    <footer className="w-full border-t border-white/5 bg-[#030303] pt-20">
      ...
      {/* 1. The Pre-Footer CTA Box (NOW WITH POP EFFECT) */}
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-8">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3 text-sm text-zinc-400">
              ...
              <li><Link href="/services" className="hover:text-[hsl(var(--theme-hue),80%,60%)] transition-colors">UI/UX Design</Link></li>
              <li><Link href="/services" className="hover:text-[hsl(var(--theme-hue),80%,60%)] transition-colors">Meta Ads</Link></li>
              <li><Link href="/services" className="hover:text-[hsl(var(--theme-hue),80%,60%)] transition-colors">Branding</Link></li>
            </ul>
          </div>
