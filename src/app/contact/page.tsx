...
import Footer from "@/components/Footer"; // The Footer is back!

export default function ContactPage() {
  
  // The Global Rainbow Engine
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-[#030303] text-white selection:bg-white/20">
        ...
        <div className="mx-auto w-full max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="flex flex-col gap-8 lg:col-span-1">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 block text-sm font-medium text-white">+94 (XXX) XXX XXX</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold uppercase tracking-widest text-zinc-500">Headquarters</p>
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <a href="#" className="flex h-12 w-12 items-center justify-center rounded-full bg-white/5 text-zinc-400 transition-all hover:bg-[hsla(var(--theme-hue),80%,60%,0.2)] hover:text-[hsl(var(--theme-hue),80%,60%)] hover:scale-110">
      ...
      {/* The Footer is completely back and styled properly */}
